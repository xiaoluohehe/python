package com.zzwc.cms.admin.modules.product.service.impl;
...
@Service
public class ProductServiceImpl extends CRUDService implements IProductService {

    @Autowired
    public ProductServiceImpl(@Qualifier(value = "cmsClient") MongoClient client) {
